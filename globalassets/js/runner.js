(function injectResources() {
  try {
    ...
    if (!alreadyInjected("favicons")) {
      const faviconData = [
        { rel: "apple-touch-icon", sizes: "180x180", href: "K3ysPlace/globalassets/favicon/apple-touch-icon.png" },
        { rel: "icon", type: "image/png", sizes: "32x32", href: "K3ysPlace/globalassets/favicon/favicon-32x32.png" },
        { rel: "icon", type: "image/png", sizes: "16x16", href: "K3ysPlace/globalassets/favicon/favicon-16x16.png" },
        { rel: "manifest", href: "K3ysPlace/globalassets/favicon/site.webmanifest" },
        { rel: "mask-icon", href: "K3ysPlace/globalassets/favicon/safari-pinned-tab.svg" },
        { rel: "shortcut icon", href: "K3ysPlace/globalassets/favicon/favicon.ico" },
      ];
