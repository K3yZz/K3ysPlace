function annoyingMessage() {
  ...
  alert("Huge Update! However 'Casino' update was delayed.");
  alert(
...
const updates = {
  ...
  "1.3.0": `
          - New design. <br>
          - Currently only Stock Market matches the theme, others still look decent. <br>
          - Casino update delayed. Improvements to wheel coming soon. <br>
          - Added new games and apps
    `,
};
...
select.addEventListener("change", () => {
  ...
  details.innerHTML = version && updates[version] ? updates[version] : "";
});
