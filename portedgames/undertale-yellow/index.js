...
const CONSOLE_layer_set_visible =
  "layer_set_visible() - could not find specified layer in current room";
const CONSOLE_layer_tilemap_get_id =
...
const CONSOLE_layer_get_all_elements =
  "layer_get_all_elements() - can't find specified layer"; // biggest pain in the ass
// crack
console.log("*************************");
...
var Module = {
  ...
  print: (function () {
    ...
    return function (text) {
      ...
      // for normal console
      if (
        text != CONSOLE_layer_set_visible &&
        text != CONSOLE_layer_tilemap_get_id &&
        text != CONSOLE_layer_depth &&
        text != CONSOLE_draw_tilemap &&
        text != CONSOLE_layer_get_all_elements
      ) {
        console.log(text);
      }
...
function togglegithub() {
  window
    .open(
      "https://github.com/burnedpopcorn/Pizza-Tower-1.1.0-Web-Port",
      "_blank"
    )
    .focus();
}
...
function manifestFilesMD5() {
  return [
    "18eac5a3371bd7267fdeaa69e5751844",
